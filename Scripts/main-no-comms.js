window.onload = function() {
  ...
  var curRing = 1;
  var maxRings = 9;
  var imgs = {playerShip:"Graphics/starship.png", enemyShip:"Graphics/starshipdark_flipped.svg", speaker:"Graphics/Icons/speaker.svg", muted:"Graphics/Icons/speaker_muted.svg", pause:"Graphics/Icons/stop_hand.svg", play:"Graphics/Icons/right_arrow.svg", stars:"Graphics/space.svg"};
  ...
  var cbs = {playerShip:blank, enemyShip:blank, speaker:blank, muted:blank, pause:blank, play:blank, stars:function() {
    if(!Modernizr.svg || three) {
  ...
  Bullet.prototype.update = function() {
    ...
    if(this.type == "friend" && this.y < -this.h) {
      ...
      if(this.type == "enemy" && this.y > canvas[0].height) {
  ...
  window.tick = function() {
    var curBGPos = parseFloat(canvas[0].style.backgroundPosition.split(" ")[1] || 0, 10);
    ...
    stage.update();
    window.playerShip.shootInt += 1E3 / 30;
  ...
  function menuScreen() {
    ...
    menuDiv.show();
    menuDiv.animate({opacity:1}, {easing:"ease-in", duration:2E3, complete:function() {
  ...
  function splashScreen(callback) {
    ...
    splash.animate({opacity:1}, {duration:1E3, complete:function() {
  ...
  window.init = function() {
    ...
    if(document.body.webkitRequestFullScreen || document.body.mozRequestFullScreen || document.body.requestFullScreen) {
      ...
      document.getElementById("enterFS").onclick = function() {
        ...
        setTimeout(function() {
          $("#fsBar").animate({top:0 - $("#fsBar").height()}, {duration:1E3, complete:function() {
    ...
    soundManager.onready(function() {
      ...
      soundManager.createSound({id:"Travel1", url:"./Sound/Music/Road Trip.mp3", volume:50, onfinish:function() {
        this.play()
      }});
      soundManager.createSound({id:"Travel2", url:"./Sound/Music/Max Loginov - Spacetraveller.mp3", volume:50, onfinish:function() {
        this.play()
      }});
      soundManager.createSound({id:"Travel3", url:"./Sound/Music/Sergey Borovkov - Phaeton.mp3", volume:50, onfinish:function() {
        this.play()
      }});
      soundManager.createSound({id:"Travel4", url:"./Sound/Music/Nicolas Millet - Aelig.mp3", volume:50, onfinish:function() {
        this.play()
      }});
      var battleVol = 75;
      window.numBattleSongs = 4;
      soundManager.createSound({id:"Battle1", volume:battleVol, url:"./Sound/Music/run_128.mp3", onfinish:function() {
        this.play()
      }});
      soundManager.createSound({id:"Battle2", volume:battleVol, url:"./Sound/Music/dragon_king_128.mp3", onfinish:function() {
        this.play()
      }});
      soundManager.createSound({id:"Battle3", volume:battleVol, url:"./Sound/Music/Rusty Boss-man Tussle.mp3", onfinish:function() {
        this.play()
      }});
      soundManager.createSound({id:"Battle4", volume:battleVol, url:"./Sound/Music/Xcentric Noizz - Trinity.mp3", onfinish:function() {
        this.play()
      }});
      soundManager.createSound({id:"Bullet", url:"./Sound/SFX/silencer.mp3", multiShot:true});
      soundManager.createSound({id:"Explosion", url:"http://wrathgames.com/blog/resources/sound/1/explosion1.mp3"});
